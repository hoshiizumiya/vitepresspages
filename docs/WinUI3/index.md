# INDEX 目录
⚠️⚠️声明：部分AI生成内容并未经过检查，你需要自行甄别其正确性，在遇到未知的问题时欢迎向我反馈。
## 疑难杂症 & 搬运视频补充内容
...
- [C++/WinRT 原理及实践 —— 页面初始化](InitializeComponent.md)
...
- MVVM 与工程化-面向使用 C++/WinRT 的开发者，涵盖 MVVM、命令模式与窗口管理等主题。
...
- [C++/WinRT 原理及实践 —— WinRT C++和C#语言实现区别](winrt-cs-grammer.md)
- [C++/WinRT 原理及实践 —— WinRT hstring类型精讲](winrt-hstring.md)
